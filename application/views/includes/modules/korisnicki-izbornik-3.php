<div id="korisnicki-izbornik" class="pocisti">
	...
	<div class="korisnicki-izbornik-opcije">
		...
		<p class="opcija"> <a href="<?php echo base_url();?>korisnik/potraznja_oglasi"> <?php echo lang('com_mod_izbornik_2_oglasi'); ?> </a> </p>
		<p class="opcija"> <a href="<?php echo base_url();?>korisnik/potraznja_novi_oglas"> <?php echo lang('com_mod_izbornik_2_novi_oglas'); ?> </a> </p>
