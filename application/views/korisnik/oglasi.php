                    ...
                    <div class="korisnik-oglasi">
                        <table>
                            ...
                            foreach ($oglasi as $o_value):
                                ?>
                                <tr>
                                    <td class="aktivan-<?php echo $o_value['vidljiv']; ?>"><?php echo $i++; ?></td>
                                    <td class="aktivan-<?php echo $o_value['vidljiv']; ?>"><?php echo $o_value['nazivObjekta']; ?></td>
                                    <td><a href="<?php echo base_url() ?>korisnik/usluge/<?php echo $o_value['oglasID']; ?>"><?php echo lang('moji_oglasi_popis_usluga'); ?></a></td>
                                    <td>
                                        <table>
                                            <tr>
                                                <td><a href="<?php echo base_url(); ?>korisnik/uredi_oglas/<?php echo $o_value['oglasID']; ?>"><?php echo lang('moji_oglasi_uredi'); ?></a></td>
                                                <td><a id="<?php echo $o_value['oglasID']; ?>" href="#"><?php echo lang('moji_oglasi_izbrisi'); ?></a></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
