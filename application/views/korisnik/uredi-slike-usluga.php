						...
						<div class="korisnik-oglasi uredi-slike pocisti">
							...
							<?php foreach ($slike_apartman as $value):?>
								<div>
									 ...
									 <p><input type="button" class="izbrisi-sliku-usluge" name="<?php echo $this->uri->segment(4).':'.$this->uri->segment(5);?>" id="<?php echo $value['naziv'].'.'.$value['ext'];?>" value="<?php echo lang('uredi_slike_izbrisi_sliku');?>" /></p>
								</div>
							<?php endforeach;?>	
								...
								<div class="form-uredi-slike cb">
									<?php echo form_open_multipart('korisnik/spremi_promjene_slika/usluga/'.$this->uri->segment(4).'/'.$this->uri->segment(5))."\n";?>
