<!-- head -->
	...
	<script type="text/javascript">
		...
		<?php foreach ($mjesta as $key => $value): ?>
			<?php if($key != $zadnji): ?>
			['<?php echo $value['naziv_mjesta'];?>', <?php echo $value['latitude']; ?>, <?php echo $value['longitude']; ?>, '<?php echo base_url().'oglas/mjesto/'.$value['mjestoID']; ?>' ],
			<?php else:?>
			['<?php echo $value['naziv_mjesta'];?>', <?php echo $value['latitude']; ?>, <?php echo $value['longitude']; ?>, '<?php echo base_url().'oglas/mjesto/'.$value['mjestoID']; ?>' ]
			<?php endif; ?>
		<?php endforeach?>
			...
			<div id="content">
				...
				<div class="content-left">
					<div class="breadcrumb" >
						<p> <a href="<?php echo base_url();?>"> <?php echo lang('com_breadcrumb_regije');?> </a> <span> >> </span>  <strong> <?php echo $regija[0]['naziv_regije']; ?> </strong> </p> 
					</div>
					<div id="map-mjesta"> <!-- Karta s mjestima --> </div>
					<div class="opcije-prikaza">
						<input type="button" id="prikazi-mjesta" value="<?php echo lang('oglas_prikazi_mjesta'); ?>"/>
						<input type="button" id="sakrij-mjesta" value="<?php echo lang('oglas_sakrij_mjesta'); ?>"/>
