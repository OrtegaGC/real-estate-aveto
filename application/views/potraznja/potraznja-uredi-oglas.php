                ...
                <div id="content">
                    ...
                    <div class="content-left">
                        <div id="novi-oglas" class="novi-oglas-potraznja">
                            ...
                            <p class="content-title item-1"> <?php echo lang('home_page_title_uredi'); ?> </p>
                            ...
                            <p class="form-field">
                                <select id="mjesto" name="mjesto">
                                    <?php foreach ($mjesto as $m_value): ?>
                                        <option value="<?php echo $m_value['mjestoID']; ?>" <?php if($oglas[0]['mjestoID'] == $m_value['mjestoID']) { echo "selected"; } ?>> <?php echo $m_value['naziv_mjesta']; ?></option>
                                    <?php endforeach; ?>
                                </select> 
                            </p>
                            ...
                            <div class="form-radio multi-column cijena pocisti">
                                <div>
                                    ...
                                    <?php echo form_error('cijena'); ?>
                                    <p class="form-field"> <input class="type-text" type="text" name="cijena"  value="<?php echo set_value('cijena'); ?>"/> </p>
                                </div>	
