<!-- header -->
	...
	<script type="text/javascript">
			function uredi() {
				var myLatlng = new google.maps.LatLng(<?php echo set_value('geo-lat'); ?>, <?php echo set_value('geo-lng'); ?>);
				var mapOptions = {
					zoom : 9,
					center : myLatlng,
				...
				var marker = new google.maps.Marker({
					position : myLatlng,
					map : map,
					title : '<?php echo set_value('naziv_objekta'); ?>'
				});
	...
	<div id="content-wrapper" class="pocisti">
		...
		<div id="sadrzaj">
			<div class="form-novi-oglas uredi uredi-oglas pocisti">
				...
				<?php echo form_open('ci_admin/opcija/spremi_promjene_oglasa')."\n"; ?>
