				...
				<div class="korisnik-oglasi uredi-slike pocisti">
					...
					<?php foreach ($slike_objekt as $value):?>
						<div>
							 ...
							 <p><input type="button" class="izbrisi-sliku-oglas" name="<?php echo $this->uri->segment(5);?>" id="<?php echo $value['naziv'].'.'.$value['ext'];?>" value="Izbriši sliku" /></p>
						</div>
					<?php endforeach;?>	
						...
						<div class="form-uredi-slike cb">
							<?php echo form_open_multipart('ci_admin/opcija/spremi_promjene_slika/oglas/'.$this->uri->segment(5))."\n";?>
					...
					<div id="dialog-confirm" title="Potvrdite za brisanje" style="display: none;">
						...
						<p class="dialog-item">Jeste li sigurni da želite izbrisati sliku</p>
					</div>
				</div>
			</div>
		</div>
