	...
	<div id="content-wrapper" class="pocisti">
		...
		<div id="sadrzaj">
			<div class="form-novi-oglas form-novi-apartman">
				<?php echo form_open_multipart('ci_admin/opcija/spremi_apartman')."\n"; ?>
					<p class="content-title item-1"> Novi apartman </p>
					<p class="form-label"> Izaberite oglas (upišite ime korisnika): <span class="required-item">*</span> </p>
					<?php echo form_error('ime_korisnika'); ?>
					<?php echo form_error('oglas'); ?>
					<div class="form-field"> 
						<input class="ime_korisnika" class="type-text" type="text" name="ime_korisnika"  value="<?php echo set_value('ime_korisnika'); ?>" autocomplete="off" /> 
