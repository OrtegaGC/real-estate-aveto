<br>
<p style="color:rgb(0,100,200);font-size:25px;">CROATIA AVETO Portal for Turist Advertising</p>
<br>
<div class="content-left">
				<br>
<br>
<p style="color:rgb(0,100,200);font-size:25px;">Billing Adress:</p>
				<br>
...
<br>
<br>
<p style="color:rgb(0,100,200);font-size:25px;">Business hours:</p>
<br>
<p style="line-height:2;font-size:14px;">Montag - Freitag: 8 - 16 h</p>
<br>				
<p style="color:rgb(0,100,200);font-size:25px;">Administration:</p>
<br>
<p style="line-height:2;font-size:14px;">
...
<p style="color:rgb(0,100,200);font-size:25px;">Contact form</p>
<br>
<br>
<p style="font-size:14px;font-weight:bold;margin-bottom:5px;">Name*</p>
<input type="text" maxlength="40" style="width:200px;font-family:Arial;"  name="ime" required="required" placeholder="Required Field!" />
<br>
<br>
<p style="font-size:14px;font-weight:bold;margin-bottom:5px;">E-mail*</p>
<input type="text" maxlength="40" style="width:200px;font-family:Arial;" name="email" required="required" placeholder="Required Field!" pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,4})$"/>
<br>
<br>
...
<textarea name="poruka" cols="40" rows="8" style="height:250px;width:550px;font-family:Arial;font-size:13px;" placeholder="Required Field"></textarea>
<br />
<br />
<input type="submit" name="posalji" id="submit" value="Send" />
</form>
<?php
