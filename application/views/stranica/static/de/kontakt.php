<br>
<p style="color:rgb(0,100,200);font-size:25px;">CROATIA AVETO Portal für  Werbung in Turismus</p>
<br>
<div class="content-left">
				<br>
<br>
<p style="color:rgb(0,100,200);font-size:25px;">Abrechnung auf diese Adresse:</p>
<br>
				<br>
...
<br>
<br>
<p style="color:rgb(0,100,200);font-size:25px;">Arbeitszeit:</p>
<br>
<p style="line-height:2;font-size:14px;">Montag - Freitag: 8 - 16 h</p>
<br>				
<p style="color:rgb(0,100,200);font-size:25px;">Verwaltung:</p>
<br>
<p style="line-height:2;font-size:14px;">
...
<p style="color:rgb(0,100,200);font-size:25px;">Senden Sie uns eine Nachricht</p>
<br>
<br>
<p style="font-size:14px;font-weight:bold;margin-bottom:5px;">Name*</p>
<input type="text" maxlength="40" style="width:200px;font-family:Arial;"  name="ime" required="required" placeholder="Erfüllen Sie dieses Feld!" />
<br>
<br>
<p style="font-size:14px;font-weight:bold;margin-bottom:5px;">E-mail Adresse*</p>
<input type="text" maxlength="40" style="width:200px;font-family:Arial;" name="email" required="required" placeholder="Erfüllen Sie dieses Feld!" pattern="^[_a-z0-9-]+(\.[_a-z0-9-]+)*@[a-z0-9-]+(\.[a-z0-9-]+)*(\.[a-z]{2,4})$"/>
<br>
<br>
<img src="/includes/images/email.png" style="float: right;margin-top:-250px;margin-right:50px;">
<p style="font-size:14px;font-weight:bold;margin-bottom:5px;">Text*</p>
<textarea name="poruka" cols="40" rows="8" style="height:250px;width:550px;font-family:Arial;font-size:13px;" placeholder="Erfüllen Sie dieses Feld!"></textarea>
<br />
<br />
<input type="submit" name="posalji" id="submit" value="Senden" />
</form>
<?php
...
<br>
<br> 
<p style="font-size:20px;color:red;">Danke für Euere Nachricht. Wir werden in kurzer Zeit Kontakt mit Ihnen nehmen!</p>
